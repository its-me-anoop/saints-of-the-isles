/* Auto-generated by tools/genmap.mjs from data/saints.final.json. */
window.SAINTS = [
  {
    "id": "duthac",
    "name": "St Duthac",
    "aka": "Duthus; Dubthach",
    "epithet": "Patron of Tain",
    "place": "St Duthus's Collegiate Church, Tain",
    ...
    "intro": "Bishop, wonder-worker, and patron of Scotland's oldest royal burgh, Duthac drew the Stuart kings on pilgrimage to the far north of Scotland for over a century — James IV made the journey barefoot every year.",
    "story": [
      "Born in Tain around 1000, Duthac was educated in Ireland before returning to serve as Bishop of Ross. Legend credits him with creating a ring of fire to protect the town and with restoring sight to the blind. He died in Armagh in 1065 and was initially buried there, but his relics were eventually returned to Tain, where they were enshrined in the collegiate church built between 1360 and 1458. Tain's Gaelic name, Baile Dhubhthaich, literally means 'Duthac's Town.'",
      "The shrine at Tain became one of the most important pilgrimage destinations in Scotland. King James IV visited every single year of his reign — often walking barefoot from Edinburgh to Ross-shire in a 200-mile act of penance. The relics vanished at the Reformation around 1560, but the medieval collegiate church survives as a visitor centre celebrating the saint's legacy."
    ],
    "facts": [
      "James IV of Scotland visited Tain on pilgrimage every year of his 25-year reign (1488–1513), making it the most consistently visited royal shrine in Scottish history.",
      "In 1306 English forces violated the sanctuary of St Duthac's Chapel to capture Robert the Bruce's wife and daughter — a sacrilege that shocked contemporaries.",
      "Tain is Scotland's oldest royal burgh by charter, a status closely linked to its importance as a pilgrimage site for the cult of Duthac."
    ],
    "wiki": "Saint Duthac",
    "quote": "",
    "accent": "66% 0.14 25",
  ...
  },
  {
    ...
    "name": "St Drostan",
    "aka": "Drostán",
    "epithet": "Founder of Old Deer",
    "place": "Deer Abbey, Old Deer",
    "region": "Aberdeenshire · Scotland",
    "country": "Scotland",
    "lat": 57.5231,
    "lng": -2.0541,
    "feast": "11 July",
    "era": "late 6th – early 7th century",
    "patronage": [
      "Aberdeenshire"
    ],
    "intro": "Disciple of Columba and founder of the monastery that produced the Book of Deer — the oldest surviving document to contain Scottish Gaelic — Drostan spent his later years as a solitary hermit in the glens of Angus.",
    "story": [
      "According to his hagiography, Drostan was an Irish nobleman of royal descent who joined Columba's community and sailed with him to Scotland. He founded the monastery of Old Deer in Aberdeenshire on land granted by a local chieftain, with Columba reportedly weeping (Gaelic: déor) as he left Drostan in charge. He served as abbot for many years before resigning to live as a hermit at Glenesk in Angus.",
      "Old Deer became one of the most significant early Christian sites in northeast Scotland. It is associated with the Book of Deer — a 9th-century Latin gospel book whose margins contain the oldest known specimens of Scottish Gaelic, added by monks in the 11th and 12th centuries. These marginal notes, recording land grants, are a priceless survival of early Scottish language and law."
    ],
    "facts": [
      "The Book of Deer, now in Cambridge University Library, contains the oldest known Scottish Gaelic writing — marginal notes recording land donations to Drostan's monastery.",
      "Drostan's hermit cell at Glenesk is associated with a holy well near Edzell that was visited for healing well into the 18th century.",
      "His relics were eventually transferred to New Aberdour on the Moray Firth coast, where a holy well dedicated to him is still marked on Ordnance Survey maps."
    ],
    "wiki": "Drostan",
    "quote": "",
    "accent": "74% 0.13 88",
  ...
  },
  {
    "id": "columba",
    "name": "St Columba",
    "aka": "Colum Cille; Colmcille",
    "epithet": "Apostle of the Picts",
    "place": "Iona Abbey, Isle of Iona",
    ...
    "intro": "An Irish prince who traded a royal destiny for a coracle, Columba crossed to the windswept island of Iona in 563 and turned it into the intellectual and spiritual powerhouse of the early medieval world.",
    "story": [
      "Born into the royal Uí Néill dynasty of Donegal on 7 December 521, Columba founded monasteries at Derry and Durrow before a dispute over the copying of a psalter — and the bloody battle it ignited — drove him into penitential exile. In 563 he sailed with twelve companions to the tiny Hebridean island of Iona, just out of sight of Ireland, and there established the monastery that would define Celtic Christianity.",
      "From Iona, Columba evangelised the Pictish kingdom of northern Scotland, famously encountering King Bridei near Inverness. His abbey became a beacon of learning and manuscript production; the Book of Kells almost certainly originated in the Iona tradition. He died peacefully in the abbey church on 9 June 597, reportedly while transcribing a psalm, and Iona remains a place of pilgrimage to this day."
    ],
    "facts": [
      "Columba reportedly wept openly on the hillside of Iona because he could see the Irish coast — the sight of home was his permanent penance.",
      "His famous encounter with a 'water beast' in the River Ness around 565 is the earliest written record of a creature resembling the Loch Ness Monster.",
      "A copyright dispute over a psalter he secretly copied produced the ruling 'to every cow her calf, to every book its copy' — sometimes called the world's first copyright judgement."
    ],
    "wiki": "Columba",
  ...
  },
  {
    ...
    "name": "St Adomnán",
    "aka": "Eunan; Adamnan",
    "epithet": "Father of the Law of Innocents",
    "place": "Iona Abbey, Isle of Iona",
    "region": "Argyll and Bute · Scotland",
    "country": "Scotland",
    "lat": 56.335,
    ...
    "intro": "The ninth abbot of Iona was a scholar-statesman who wrote the defining Life of Columba, produced the world's first pilgrimage guide to the Holy Land, and drafted one of history's earliest written laws protecting non-combatants in war.",
    "story": [
      "Born in County Donegal around 624, Adomnán entered the Columban monastery and became the ninth abbot of Iona in 679, ruling for twenty-five years. A trusted diplomat, he negotiated the release of Irish captives from the Northumbrian king Aldfrith. His most enduring literary achievement is the Vita Columbae (Life of Columba), completed around 697 — one of the finest hagiographies of the age.",
      "In 697, at the Synod of Birr, Adomnán promulgated the Cáin Adomnáin — the 'Law of Innocents' — one of the earliest codified protections for women, children, and clergy in warfare, adopted by rulers across Ireland and Scotland. He also wrote De Locis Sanctis, the first detailed guide to the Holy Land for western pilgrims."
    ],
    "facts": [
      "The Cáin Adomnáin of 697 is considered one of the earliest forerunners of the modern Geneva Conventions — enacted 1,200 years before the first Geneva Convention.",
      "His Life of Columba includes what may be the world's first written reference to the Loch Ness Monster.",
      "He tried and failed to persuade the Iona community to adopt the Roman Easter calculation — the reform was only accepted after his death."
    ],
    "wiki": "Adomnán",
    "quote": "",
    "accent": "60% 0.15 312",
  ...
  },
  {
    ...
    "aka": "",
    "epithet": "Pearl of Scotland",
    "place": "Dunfermline Abbey, Dunfermline",
    ...
    "intro": "An Anglo-Saxon princess shipwrecked on the Scottish coast, Margaret became queen, mother of three kings, and the most transformative reformer of the medieval Scottish Church — all before her death at 47.",
    "story": [
      "Born in Hungary around 1045 to the English prince Edward the Exile, Margaret fled to Scotland in 1068 after the Norman Conquest, when her ship was driven aground in the Firth of Forth. King Malcolm III fell in love with her and she became Queen of Alba in 1070. She brought Benedictine monks to Scotland, founded the abbey at Dunfermline, revived the ancient ferry across the Forth for pilgrims, and aligned Scottish Church practice with Rome — all while raising a family of eight.",
      "She died at Edinburgh Castle on 16 November 1093, reportedly just three days after receiving news of her husband and eldest son's deaths at the Battle of Alnwick. Canonised by Pope Innocent IV in 1250, she was declared Patroness of Scotland in 1673, and her body was enshrined at Dunfermline Abbey."
    ],
    "facts": [
      "Margaret is the only medieval Scottish person to be formally canonised by Rome.",
      "She mothered three kings of Scotland (Edgar, Alexander I, David I) and a queen of England (Matilda, wife of Henry I).",
      "Her confessor Turgot wrote the first female-focused biography in Scottish history, noting she often gave away her own food at table before eating herself."
    ],
  ...
  },
  {
    "id": "triduana",
    "name": "St Triduana",
    "aka": "Trodline; Tredwell",
    "epithet": "Healer of Blindness",
    "place": "St Triduana's Aisle, Restalrig, Edinburgh",
    "region": "Edinburgh · Scotland",
    "country": "Scotland",
    "lat": 55.9577,
    "lng": -3.1497,
    "feast": "8 October",
    "era": "c. 7th – 8th century",
    "patronage": [
      "those with eye diseases"
    ],
    "intro": "To repel a Pictish king besotted by the beauty of her eyes, Triduana tore them out and sent them to him on a skewer — and in doing so became Scotland's most invoked healer of blindness for over a thousand years.",
    "story": [
      "According to the Aberdeen Breviary, Triduana was a noblewoman from Greece who accompanied the monk Regulus on his legendary voyage carrying St Andrew's relics to Scotland. She settled as a hermit at Rescobie in Angus, but the Pictish king Nechtan came to her drawn by the beauty of her eyes. When told it was her eyes he loved most, she tore them out with a thorn and sent them to him impaled on a skewer.",
      "Her principal shrine was at Restalrig, on the eastern edge of Edinburgh, where a remarkable hexagonal, two-storey, partly subterranean chapel was built around 1487. This became one of the most visited pilgrimage sites in Scotland, with sufferers of eye diseases coming from across the country. The chapel was largely demolished at the Reformation in 1560, but the finely vaulted lower storey survives."
    ],
    "facts": [
      "The surviving lower chapel at Restalrig features superb 15th-century rib-vaulting and was long mistaken for an unusually elaborate holy well-house rather than a two-storey chapel.",
      "Her cult spread to Orkney, where a church at Papa Westray was dedicated to her under the Norse form 'Trøllhaena.'",
      "King James IV of Scotland visited Restalrig at least twice and paid for wax votive offerings at the shrine — the royal accounts record his payments."
    ],
    "wiki": "Triduana",
    "quote": "",
    "accent": "72% 0.13 132",
  ...
  },
  {
    ...
    "name": "St Cuthbert",
    "aka": "",
    "epithet": "Wonder-worker of England",
    ...
    "intro": "A shepherd boy who became the most beloved saint of Northern England, Cuthbert drew pilgrims to his tomb at Durham Cathedral for centuries after his body was found incorrupt eleven years after death.",
    "story": [
      "Born into a Northumbrian family around 634, Cuthbert entered the monastery at Melrose after a vision of angels carrying Aidan of Lindisfarne's soul to heaven. He became Prior of Lindisfarne and then Bishop, but his truest vocation was as a hermit on the bleak tidal island of Inner Farne, where he lived alone with only eider ducks and seals for company.",
      "He died on 20 March 687 and was buried on Lindisfarne. When monks opened his coffin eleven years later, his body was found perfectly preserved — a sign of sanctity that ignited a cult lasting centuries. Fleeing Viking raids, monks carried his remains across Northumbria for over a century before he finally came to rest in Durham, where his shrine became the greatest pilgrimage destination in northern England."
    ],
    "facts": [
      "Cuthbert is said to have kept vigil waist-deep in the North Sea overnight, and in the morning otters came ashore to warm his feet — the eider duck is still called 'Cuddy's duck' in Northumberland.",
      "His decorated seventh-century coffin, portable altar, and pectoral cross — found when his tomb was opened in 1104 — rank among the finest surviving objects of Anglo-Saxon art.",
      "Bede recounted the monks' astonishment at finding flesh and limbs still supple when the coffin was opened in 698."
    ],
    "wiki": "Cuthbert",
  ...
  {
    "id": "bartholomew-of-farne",
    "name": "St Bartholomew of Farne",
    "aka": "",
    "epithet": "Hermit of Inner Farne",
    "place": "Inner Farne Island",
    "region": "Northumberland · England",
    "country": "England",
    "lat": 55.6181,
    "lng": -1.6487,
    ...
    "intro": "Born in Whitby, ordained in Norway, and drawn back to the same rocky tidal island where St Cuthbert had lived five centuries before, Bartholomew spent 42 years as a hermit on Inner Farne — longer than any other occupant of that holy cell.",
    "story": [
      "The man who became St Bartholomew began life as Tostig, the son of Scandinavian settlers in Whitby. After being ordained a priest in Norway, he returned to England and became a monk at Durham Cathedral Priory. A vision of St Cuthbert sent him to occupy Cuthbert's ancient hermitage on Inner Farne, a bare basalt island, where he arrived around 1150.",
      "He remained there for over four decades, enduring extreme isolation, North Sea winters, and the company of seabirds. Fellow hermits occasionally shared the island but seldom lasted; Bartholomew outlasted them all. When he died in 1193, monks from Durham came to collect his body, and his tomb there became a minor focus of pilgrimage."
    ],
    "facts": [
      "Bartholomew occupied the same hermitage cell on Inner Farne that St Cuthbert had used in the 670s, continuing an unbroken tradition of holy men on that island.",
      "He bore three different names in his lifetime: Tostig at birth, William in youth, and Bartholomew after entering monastic life.",
      "He is said to have been so tranquil that the famously ferocious seabirds of Inner Farne would nest peacefully around him."
    ],
  ...
  {
    "id": "oswald-of-northumbria",
    "name": "St Oswald",
    "aka": "Oswald of Northumbria",
    "epithet": "King and Martyr of Northumbria",
    "place": "Heavenfield, near Hexham",
    "region": "Northumberland · England",
    "country": "England",
    "lat": 55.0207,
    "lng": -2.1001,
    ...
    "intro": "A king converted by Irish monks on Iona who erected a wooden cross before his greatest battle and then invited Aidan to evangelise his kingdom — Oswald of Northumbria was venerated across Europe for his miraculous healing relics.",
    "story": [
      "Exiled as a boy when his father was killed, Oswald spent his formative years among the monks of Iona, where he was baptised. Returning to claim the throne of Northumbria in 633, he paused his army the night before battle near Hadrian's Wall and erected a large wooden cross, commanding his soldiers to kneel and pray. His victory over the larger forces of Cadwallon the next day was attributed to that cross; the site became known as Heavenfield.",
      "As king, Oswald invited Aidan from Iona and gave him Lindisfarne for a monastery, personally serving as his interpreter. He was killed at the Battle of Maserfield in 642 by the pagan Mercian king Penda. His head is believed to rest with Cuthbert's remains in Durham Cathedral, and his cult spread across Europe."
    ],
    "facts": [
      "Bede records that soil from the spot where Oswald fell was so holy that pilgrims carried it away in bags, excavating the site to waist depth within a generation.",
      "Churches were dedicated to him in Ireland, Switzerland, the Netherlands, and Germany — making him one of the most internationally venerated Anglo-Saxon saints.",
      "His right arm was kept incorrupt at Bamburgh, said never to decay — a testimony to his generosity in using that arm to distribute food to the poor."
    ],
  ...
  },
  {
    ...
    "aka": "The Venerable Bede",
    "epithet": "Father of English History",
    "place": "St Paul's Monastery, Jarrow",
    "region": "Tyne and Wear · England",
    "country": "England",
    "lat": 54.982,
    "lng": -1.4736,
    "feast": "25 May",
    ...
    "intro": "The monk who never left his monastery yet wrote the book that gave England its history: Bede's Ecclesiastical History, completed in 731, remains the primary source for the first seven centuries of English Christianity.",
    "story": [
      "Brought to the twin monastery of Wearmouth-Jarrow at the age of seven, Bede scarcely set foot outside its walls for the rest of his life — yet no scholar of his age ranged further in learning. He wrote over sixty works covering theology, chronology, natural science, poetry, and biography, all in a Northumbrian scriptorium enriched by the library Benedict Biscop had assembled from five journeys to Rome.",
      "On his deathbed in 735 Bede was still translating the Gospel of John into Old English. When his scribe told him the final chapter was done, Bede said simply, 'All is finished' — and died shortly afterwards. He was declared a Doctor of the Church by Pope Leo XIII in 1899, the only native of Great Britain ever to hold that title."
    ],
    "facts": [
      "Bede popularised the system of dating events as BC and AD so effectively that it became the global standard — every year number written today uses Bede's innovation.",
      "His Ecclesiastical History records Cædmon of Whitby, the cowherd who received the gift of song in a dream — the earliest documented account of an English literary figure.",
      "He correctly described the spherical shape of the Earth and the workings of the tides over a thousand years before these became common knowledge."
    ],
    "wiki": "Bede",
  ...
  {
    "id": "benedict-biscop",
    "name": "St Benedict Biscop",
    "aka": "Biscop Baducing",
    "epithet": "Founder of Wearmouth-Jarrow",
    "place": "St Peter's Church, Monkwearmouth, Sunderland",
    "region": "Tyne and Wear · England",
    "country": "England",
    "lat": 54.913,
    "lng": -1.3752,
    ...
    "intro": "A Northumbrian nobleman who abandoned a court career to make five pilgrimages to Rome and return each time with books, relics, paintings, and craftsmen — building the twin monastery that became the engine room of English learning.",
    "story": [
      "Benedict Biscop was a thegn in the household of King Oswiu when, in his mid-twenties, he renounced his lands to become a monk. He made five journeys to Rome, each time loading ships with manuscripts, icons, vestments, and craftsmen who knew how to build in stone and set glass. In 674 he founded St Peter's at Wearmouth; eight years later he added St Paul's at Jarrow.",
      "His twin monastery became one of the greatest intellectual centres in western Europe. The library he assembled — around 250 volumes — gave the young Bede access to sources no other English scholar could match. He died in 690 after three years of paralysis, borne with unfailing patience. The porch of his original church at Monkwearmouth still stands, one of the oldest pieces of building in England."
    ],
    "facts": [
      "Benedict brought the first glaziers to England to glaze his church windows — coloured glass had been essentially unknown in the country before his commission.",
      "The Codex Amiatinus, the oldest complete manuscript of the Latin Bible in existence, was produced at his monastery at Jarrow around 710 using calfskin from 515 animals.",
      "He imported John, the Arch-cantor of St Peter's Basilica in Rome, who stayed at Wearmouth for a year teaching the monks the full Roman liturgical chant."
    ],
  ...
  },
  {
    ...
    "name": "St Hilda",
    "aka": "Hild of Whitby",
    "epithet": "Abbess of Whitby, Mother of Bishops",
    "place": "Whitby Abbey",
    ...
    "intro": "The most powerful churchwoman in seventh-century England, Hilda ruled a double monastery of monks and nuns at Whitby and hosted the great Synod that determined how Christianity would be celebrated across the entire English nation.",
    "story": [
      "Born a Northumbrian princess and baptised by Paulinus, Hilda spent her first thirty-three years at court before dedicating herself to God. She became abbess of Hartlepool and then, in 657, founded her great double monastery at Streonaeshalch — later called Whitby — on the clifftops above the North Sea. Five of her monks became bishops, earning her the title 'Mother of Bishops.'",
      "In 664 King Oswiu chose Whitby as the venue for the Synod that settled the controversy of Celtic versus Roman Christianity. Hilda sided with the Celtic tradition but accepted the king's ruling for Rome. She is also remembered for discovering the gift of Cædmon, an illiterate cowherd who received the ability to compose sacred verse in a dream — the first named poet in the English language."
    ],
    "facts": [
      "Local legend says Hilda turned the snakes around Whitby to stone — a folklore explanation for the ammonite fossils found on the beach below the abbey, still sold as 'snakestones.'",
      "According to medieval tradition, seabirds flying over the abbey ruins dip their wings in homage to St Hilda as they pass.",
      "St Hilda's College, Oxford, founded in 1893 as a college for women, bears her name in tribute to her legacy as a patron of women's education."
    ],
  ...
  },
  {
    ...
    "name": "St Wilfrid",
    "aka": "",
    "epithet": "Champion of Roman Order",
    "place": "Ripon Cathedral",
    "region": "North Yorkshire · England",
    "country": "England",
    "lat": 54.1381,
    "lng": -1.5221,
    ...
    "intro": "The stormy genius of the early English church, Wilfrid argued for Roman Christianity at the Synod of Whitby, introduced the Benedictine Rule to England, and appealed to Rome three times when his own king tried to strip him of his bishopric.",
    "story": [
      "Educated at Lindisfarne but dissatisfied with its Celtic traditions, the young Wilfrid travelled to Rome and returned convinced the English church must align with papal authority. At the Synod of Whitby in 664, his eloquent argument won King Oswiu to the Roman side. He became Bishop of York and built remarkable stone churches at Hexham and Ripon, importing continental craftsmen to create barrel-vaulted crypts that still survive.",
      "His turbulent relationship with Northumbrian kings led to three exiles and multiple appeals to Rome — an unprecedented use of papal authority by an English bishop. During one exile he converted the pagan South Saxons. He died in 709 and was buried at Ripon, where his crypt is one of the oldest intact Anglo-Saxon structures in England."
    ],
    "facts": [
      "Wilfrid's crypt at Ripon, hewn from solid rock around 672, is the oldest Anglo-Saxon crypt in England still accessible to visitors.",
      "According to Bede, when Wilfrid began baptising converts in drought-stricken Sussex, rain fell for the first time in three years.",
      "He introduced the Rule of Saint Benedict to Northumbrian monasteries and brought the full choral antiphon-singing style from Rome, transforming the sound of English worship."
    ],
    "wiki": "Wilfrid",
    "quote": "",
    "accent": "70% 0.12 78",
  ...
  },
  {
    ...
    "aka": "William fitzHerbert",
    "epithet": "Twice Archbishop, Once Martyr",
    ...
    "intro": "Deposed from his archbishopric by the Cistercian reform party, restored after his enemies all died, and then allegedly poisoned in the Eucharistic chalice — William of York is the least-known of England's great medieval cathedral saints.",
    "story": [
      "A great-nephew of William the Conqueror and treasurer of York Minster, William fitzHerbert was elected Archbishop of York in 1140, only to face opposition from the Cistercian reformers led by Bernard of Clairvaux, who accused him of simony. He was deposed in 1147 and spent six years in humble exile at Winchester, reportedly genuinely penitent.",
      "After the deaths of all his accusers, William was restored to York in 1153. His triumphant return procession crossed the Ouse Bridge, which collapsed under the weight of the crowd; not one person was killed, the miracle attributed to his prayers. He died the following year, allegedly poisoned in the chalice at Mass by a jealous archdeacon. Canonised in 1226, his shrine made York a major pilgrimage destination alongside Canterbury."
    ],
    "facts": [
      "The collapse of Ouse Bridge under his welcoming crowds, with no fatalities, was cited as the primary miracle at his canonisation.",
      "His suspected poisoner, the archdeacon Osbert de Bayeux, was never tried because King Stephen died within weeks and proceedings collapsed.",
      "The William of York window in York Minster, dating from around 1414, is one of the finest medieval stained glass narrative cycles in England."
    ],
  ...
  {
    "id": "margaret-clitherow",
    "name": "St Margaret Clitherow",
    "aka": "The Pearl of York",
    "epithet": "Martyr of the Shambles",
    "place": "The Shambles, York",
    "region": "North Yorkshire · England",
    "country": "England",
    "lat": 53.9593,
    "lng": -1.0801,
    ...
    "intro": "A York butcher's wife who hid priests in her home during the Elizabethan persecutions and was pressed to death with an 800-pound weight for refusing to plead — Margaret Clitherow is the most vivid of all English martyrs.",
    "story": [
      "Margaret Middleton married John Clitherow, a prosperous York butcher, at fifteen. Around 1574 she converted to Catholicism and began the dangerous work of sheltering priests in a trapdoor-concealed room of her house in the Shambles. She organised a school for Catholic children and practised her faith with a joy her confessor described as almost reckless.",
      "In March 1586 a search of her home revealed the priests' hiding place. Rather than enter a plea and thereby expose her children and servants to examination under torture, Margaret refused to plead at all — knowing this meant she would be pressed to death. On 25 March 1586, Good Friday, she was crushed under an 800-pound weight and died within fifteen minutes. Canonised in 1970 as one of the Forty Martyrs of England and Wales, her hand is venerated at the Bar Convent in York."
    ],
    "facts": [
      "Margaret was pregnant with her fourth child at her execution; the judges, legally obliged to spare pregnant women, proceeded regardless.",
      "Gerard Manley Hopkins composed a poem in her honour, calling her 'the rarest-veined unraveller.'",
      "Her left hand, the only surviving bodily relic, is displayed at the Bar Convent in York — the oldest active convent in England."
    ],
  ...
  },
  {
    ...
    "aka": "Hugh of Avalon",
    "epithet": "The Carthusian Bishop",
    "place": "Lincoln Cathedral",
    "region": "Lincolnshire · England",
    "country": "England",
    "lat": 53.2344,
    "lng": -0.5363,
    ...
    "intro": "Hugh of Lincoln kept a tame swan that guarded him while he slept, drove off strangers with savage bites, yet ate calmly from his master's hand — and the bishop treated the bird as a friend and sign of grace.",
    "story": [
      "Born in Burgundy and trained as a Carthusian monk, Hugh was brought to England by Henry II around 1175 to reform Witham Charterhouse, the first Carthusian house in England. His success was so striking that in 1186 Henry appointed him Bishop of Lincoln, the largest diocese in England. He set about rebuilding Lincoln Cathedral after the 1185 earthquake, beginning the great Gothic choir.",
      "Hugh was famously fearless before power. He excommunicated royal forest officials who abused peasants, refused unjust military funds, and stood between Jewish communities and the anti-Jewish riots that swept England during the Third Crusade. He died in London in 1200 and was canonized in 1220 — the first Carthusian monk to be declared a saint."
    ],
    "facts": [
      "Hugh personally carried stones for the rebuilding of Lincoln Cathedral alongside the labourers.",
      "His pet swan at Stow Park would attack anyone who came near the bishop but slept beside him with its neck tucked under Hugh's chin — his standard iconographic attribute.",
      "At his funeral, King John of England and King William of Scotland both helped carry his coffin."
    ],
  ...
  {
    "id": "etheldreda-of-ely",
    "name": "St Æthelthryth",
    "aka": "Etheldreda; St Audrey",
    "epithet": "Abbess of Ely, Virgin Queen",
    "place": "Ely Cathedral, Ely",
    ...
    "intro": "Princess, twice-married queen, and determined virgin who escaped her husband across the Fens — Æthelthryth founded Ely Abbey and gave English the word 'tawdry.'",
    "story": [
      "Born to King Anna of East Anglia, Æthelthryth was married twice by political necessity while maintaining a vow of perpetual virginity. Around 672 she persuaded her second husband Ecgfrith to release her, fled south, and founded a double monastery on the Isle of Ely. She served as abbess until her death from a neck tumour in 679, which she accepted as divine punishment for the gold necklaces she had worn as a young queen.",
      "When her body was examined sixteen years after burial, it was found uncorrupted, the neck tumour healed. Bede recorded the miracle and wrote a hymn in her honour. Her shrine at Ely became one of the most visited in medieval England. Each year a fair at Ely sold cheap silk necklaces called 'St Audrey's lace' — which by the 17th century had contracted to 'tawdry.'"
    ],
    "facts": [
      "The English word 'tawdry' derives directly from her name: cheap lace sold at her Ely fair was called 'Saint Audrey's lace,' slurring over time into 'tawdry.'",
      "When her body was disinterred in 695, a Roman marble sarcophagus discovered near Cambridge was found to fit her perfectly — which Bede records as a miracle.",
      "More medieval vernacular lives were written about her than any other native English female saint."
    ],
    "wiki": "Æthelthryth",
    "quote": "",
    "accent": "60% 0.13 168",
  ...
  {
    "id": "felix-of-burgundy",
    "name": "St Felix of Burgundy",
    "aka": "Felix of Dunwich",
    "epithet": "Apostle of the East Angles",
    "place": "Dunwich",
    ...
    "intro": "A Burgundian bishop who crossed the Channel and in seventeen years of missionary work converted an entire kingdom — Bede said he freed East Anglia from 'long-standing evil and unhappiness.'",
    "story": [
      "Felix was born in the Frankish kingdom of Burgundy and made his way to Canterbury, where he met Archbishop Honorius around 630. The exiled King Sigeberht of East Anglia, returned from Frankish exile a committed Christian, sought a missionary bishop for his people. Honorius sent Felix, granting him a see at Dommoc — most often identified with Dunwich in Suffolk.",
      "Felix founded schools on the Frankish model and worked alongside the Irish monk Fursey. He served as bishop for seventeen years, dying in 647. His name survives at Felixstowe in Suffolk, meaning 'the holy place of Felix.'"
    ],
    "facts": [
      "Bede wrote that Felix freed the whole of East Anglia from 'long-standing evil and unhappiness' — one of the strongest endorsements he ever gave a missionary bishop.",
      "His relics were removed to Ramsey Abbey in 971, making Dunwich — now largely swallowed by the North Sea — one of England's most haunting lost holy sites.",
      "Felixstowe in Suffolk almost certainly takes its name from him."
    ],
  ...
  {
    "id": "edmund-the-martyr",
    "name": "St Edmund the Martyr",
    "aka": "Edmund, King of East Anglia",
    "epithet": "King and Martyr of East Anglia",
    "place": "Bury St Edmunds Abbey",
    "region": "Suffolk · England",
    "country": "England",
    "lat": 52.2441,
    "lng": 0.7192,
    ...
    "intro": "Tied to a tree, shot through with arrows like a hedgehog, and beheaded for refusing to renounce Christ to a Danish warlord — Edmund's death transformed a young king into the patron saint of England for three centuries.",
    "story": [
      "Edmund became king of the East Angles around 855 and ruled for over a decade before the Great Heathen Army of the Danes swept into his kingdom in 869. According to Abbo of Fleury, the Danish leader Ivar the Boneless demanded Edmund rule as a puppet king and abandon Christianity. Edmund refused, and was captured near Hoxne, scourged, used for target practice by Danish archers, and beheaded.",
      "His head was miraculously guarded in the forest by a wolf until found by his followers, and his body interred at Beodricesworth — the town that became Bury St Edmunds. By the 10th century his cult rivalled Becket's; his abbey became one of England's wealthiest. He was considered England's patron saint until St George displaced him in the late 14th century."
    ],
    "facts": [
      "The word 'Bury' in Bury St Edmunds means 'burh' — a fortified place — built around Edmund's shrine; the town's existence is a monument to his martyrdom.",
      "A wolf is said to have guarded Edmund's severed head, calling 'Here! Here!' to lead the search party to it.",
      "Edmund appears on the Wilton Diptych (c. 1395) presenting Richard II to the Virgin, flanking the king with St Edward the Confessor and John the Baptist."
    ],
  ...
  {
    "id": "botolph-of-thorney",
    "name": "St Botolph",
    "aka": "Botwulf",
    "epithet": "Patron of Travellers and Wayfarers",
    "place": "St Botolph's Church, Iken",
    "region": "Suffolk · England",
    "country": "England",
    "lat": 52.1553,
    "lng": 1.5249,
    "feast": "17 June",
    "era": "early 7th century – c. 680",
    "patronage": [
      "travellers",
      "wayfarers",
      "boundaries",
    ...
    "intro": "The East Anglian abbot who drove demons out of a marsh and built a monastery on a tidal estuary — and whose name is still pronounced every day in the city of Boston, Massachusetts.",
    "story": [
      "Botolph received his monastic training on the Continent and returned to England seeking a place for a new monastery. In 654 the East Anglian king granted him a tract of land called Icanho — now Iken on the estuary of the River Alde — which was then marshy and reputedly haunted. His biographer records that Botolph drove out evil spirits before building his monastery, which became a centre of learning.",
      "After his death around 680, his cult spread with remarkable speed; between 64 and 71 ancient English churches bear his name. In London, four churches near the old city gates were dedicated to him, since as patron of travellers his shrines flanked the points where people entered and left the city. The settlement near his original monastery became Boston in Lincolnshire — and in 1630 Puritan emigrants named their Massachusetts settlement after it."
    ],
    "facts": [
      "Boston, Massachusetts takes its name from Botolph's Town in Lincolnshire, which derives from the saint.",
      "Four churches inside the old walls of London were dedicated to him — at Aldgate, Aldersgate, Bishopsgate, and Billingsgate — because as patron of travellers he guarded every city gate.",
      "St Botolph's Church still stands at Iken on the same tidal peninsula as his monastery, a rare continuity of twelve-and-a-half centuries."
    ],
  ...
  },
  {
    ...
    "name": "St David",
    "aka": "Dewi Sant",
    "epithet": "Patron Saint of Wales",
    "place": "St Davids Cathedral, St Davids",
    ...
    "intro": "The patron saint of Wales spent his life founding monasteries, preaching with miraculous effect, and reputedly living on nothing but leeks and water — earning the nickname Dewi Ddyfrwr, David the Water Drinker.",
    "story": [
      "Born around 500 in Ceredigion, David founded a monastic community at Mynyw (now St Davids) in the far south-west of Wales, where his austere rule demanded manual labour, no draught animals, and a diet of bread, water, and vegetables. His fame spread across Britain and Brittany, and more than fifty churches across Wales bore his name within a few centuries.",
      "At the Synod of Brefi around 550, David's preaching against Pelagianism was so compelling that the ground allegedly rose beneath his feet so all could hear him. Pope Callixtus II canonised him in 1123, and his shrine at St Davids became one of the great medieval pilgrimage destinations — two visits there rated equal to one journey to Rome. His last words, 'Do ye the little things in life,' remain a living Welsh proverb."
    ],
    "facts": [
      "David was reputedly a strict vegetarian who drank only water, a remarkable asceticism even by 6th-century monastic standards.",
      "His cathedral is in Britain's smallest city — the settlement never grew because David reportedly forbade any town from forming around his monastery.",
      "Pope Callixtus II's 1123 decree stated that two pilgrimages to St Davids equalled one to Rome."
    ],
    "wiki": "Saint David",
  ...
  },
  {
    ...
    "name": "St Non",
    "aka": "Nonnita",
    "epithet": "Mother of St David",
    "place": "Chapel of St Non, St Davids",
    "region": "Pembrokeshire · Wales",
    "country": "Wales",
    "lat": 51.8723,
    "lng": -5.2667,
    ...
    "intro": "The mother of Wales's patron saint, Non gave birth to David during a violent storm on a Pembrokeshire cliff, and the ancient ruined chapel marking the spot — aligned north-south, uniquely — still draws pilgrims to her holy well beside the sea.",
    "story": [
      "Non was a consecrated virgin living near St Davids when, according to tradition, she conceived David. The Life of St David, written by Rhigyfarch around 1095, records that during her pregnancy no preacher could speak in her presence — a sign of the holiness of the child she carried. When she gave birth during a storm, a blinding light filled the cliff and a spring of healing water burst forth at the spot where she knelt.",
      "The ruined Chapel of St Non, perched on the coastal headland south of St Davids Cathedral, is unusual in being oriented north-south rather than the customary east-west. Non later retired to Cornwall and then to Brittany, where she died at Dirinon. A modern chapel was built near the ruins in 1934 and continues to receive pilgrims."
    ],
    "facts": [
      "The ruined chapel at the site of David's birth is aligned north-south instead of the standard east-west — an anomaly suggesting it pre-dates the Christianisation of the site.",
      "Non is venerated in Wales, Cornwall, and Brittany — three of the six Celtic nations.",
      "A holy well beside the ruins is said to heal eye ailments and has never been known to run dry."
    ],
    "wiki": "Saint Non",
    "quote": "",
    "accent": "64% 0.12 218",
  ...
  },
  {
    ...
    "name": "St Cadoc",
    "aka": "Cattwg Ddoeth",
    "epithet": "The Wise, Abbot of Llancarfan",
    "place": "St Cadoc's Church, Llancarfan",
    "region": "Vale of Glamorgan · Wales",
    "country": "Wales",
    "lat": 51.4228,
    "lng": -3.3659,
    ...
    "intro": "Known as Cattwg Ddoeth — the Wise — Cadoc presided over the first great monastic school of South Wales at Llancarfan, which trained Illtud himself and whose fame reached from Scotland to Brittany.",
    "story": [
      "Born around 497, son of Gwynllyw, King of Gwynllwg, Cadoc founded his celebrated monastery at Llancarfan in the Vale of Glamorgan, the foremost centre of learning in early South Wales — even Illtud spent an early period there as his student. His maxims were gathered into a collection preserved in the Myvyrian Archaiology.",
      "Cadoc's sphere of influence was vast: he established monasteries in Scotland, Brittany, and Cornwall. His Life, written by Lifris of Llancarfan before 1086, contains independent references to King Arthur, making it one of the oldest Arthurian sources outside Geoffrey of Monmouth. He is venerated in Scotland under the name Catoc."
    ],
    "facts": [
      "Cadoc's Life, written before 1086, is one of the earliest surviving sources to mention King Arthur independently of Geoffrey of Monmouth.",
      "His influence stretched to Scotland, where he founded the monastery at Cambuslang near Glasgow around 528.",
      "Called 'the Wise,' his moral maxims were preserved in one of the great anthologies of medieval Welsh literature."
    ],
    "wiki": "Cadoc",
    "quote": "",
    "accent": "60% 0.15 312",
  ...
  },
  {
    ...
    "name": "St Petroc",
    "aka": "",
    "epithet": "Captain of the Cornish Saints",
    "place": "Bodmin Priory, Bodmin",
    ...
    "intro": "A Welsh prince who gave up his throne to preach in the south-west, allegedly walked to India, tamed a wolf, and whose stolen relics were recovered by a king — Petroc is the most celebrated of all Cornish saints.",
    "story": [
      "Petroc, traditionally a prince of Gwent, sailed to Cornwall after studying in Ireland and founded a monastic community at Padstow ('Petroc's Stow'). He spent decades walking the wild western peninsula, establishing churches and taming animals. One legend describes him travelling across the sea to an island paradise near India for a period of solitary retreat. His icon typically shows him with a wolf, whose stolen cub he is said to have returned.",
      "After his death around 564, his principal relics were kept at Padstow before moving to Bodmin, the most important monastic centre in Cornwall. In 1177 a Breton cleric stole the relics; Henry II personally intervened to secure their return. The ivory reliquary casket that once held them — decorated with Arabic interlace, probably made in Sicily — survives at St Petroc's Church in Bodmin."
    ],
    "facts": [
      "Thomas Fuller called Petroc 'the captain of Cornish saints' — he has more church dedications in Cornwall and Devon than any other local saint.",
      "His stolen relics were recovered in 1177 after Henry II wrote personally to the Breton monastery demanding their return.",
      "His 12th-century ivory reliquary casket, inlaid with hunting scenes in an Islamic artistic tradition, is kept at Bodmin and is thought to have been crafted in Norman Sicily."
    ],
    "wiki": "Saint Petroc",
    "quote": "",
    "accent": "66% 0.14 25",
  ...
  },
  {
    ...
    "name": "St Piran",
    "aka": "Perran",
    "epithet": "Patron Saint of Cornwall and of Tin-Miners",
    "place": "St Piran's Oratory, Perranzabuloe",
    "region": "Cornwall · England",
    "country": "England",
    "lat": 50.3651,
    "lng": -5.139,
    "feast": "5 March",
    "era": "5th century (died c. 480)",
    "patronage": [
      "Cornwall",
      "tin-miners"
    ],
    "intro": "Thrown into the Atlantic tied to a millstone by an Irish king, Piran floated calmly to Cornwall, befriended a badger, a fox, and a boar, and — when his hearthstone oozed liquid tin — accidentally rediscovered the secret of smelting that made Cornwall wealthy.",
    "story": [
      "Piran is believed to have been an Irish abbot who arrived on the north Cornish coast in the 5th century after a miraculous sea voyage. He established a tiny hermitage in the sand dunes near Perranzabuloe — his first oratory, buried beneath the dunes of Penhale Sands, is among the oldest standing Christian buildings in Britain. His first companions, according to the Life, were a badger, a fox, and a boar.",
      "The legend of his discovery of tin — that the black stone of his fireplace ran white metal when heated — made him patron saint of Cornish tinners, whose trade guild celebrated his feast as a public holiday into the 18th century. His black-and-white flag, the Cross of St Piran, became Cornwall's emblem. On 5 March each year, thousands walk across the dunes to his oratory for the St Piran's Day procession."
    ],
    "facts": [
      "St Piran's Oratory in the Penhale dunes is often cited as one of the oldest complete Christian buildings in Britain.",
      "His first 'parishioners' were a badger, a fox, and a boar — until a jealous cat broke the harmony, a detail that reads as pointed social commentary.",
      "Cornwall's county flag — a white cross on a black field — depicts Piran's legend of tin smelted from black ore, one of the few flags with an industrial origin myth."
    ],
    "wiki": "Saint Piran",
    "quote": "",
    "accent": "64% 0.12 218",
